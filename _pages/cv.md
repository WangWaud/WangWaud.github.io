...
**Project 1:** 基于 CRISPR/Cas9 基因编辑技术研究重组酵母 SF4 木糖代谢调控机制并获得“超级高产乙醇酵母”

- **Time**: 2019.03-2021.06
- **Supervisor**: Liangcai Peng (HZAU)
- **Level**: National College Students Innovation and Entrepreneurship Training Program
- **Major**: CRISPR/Cas9 method in recombinant engineering yeast mutant construction.


**Project 2:** Development of bioethanol detection type yeast sensor

- **Time**: 2019.03-2022.06
- **Supervisor**: Liangcai Peng (HZAU)
- **Level**: Undergraduate Graduation Project


**Project 3:** 开发基于生物质量子点检测乙醇浓度的新方法及其荧光共振能量转移（FRET）机理的研究
